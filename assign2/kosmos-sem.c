 ...
 */
int termination = 0; // boolean used to signal when all radicals have been formed
int max_radicals = 0;
...
sem_t sem1; // Semaphore to protect critical section
...
void kosmos_init() {
    sem_init(&sem1, 0, 1); // semaphore to protect shared variables
